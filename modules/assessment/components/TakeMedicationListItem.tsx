...
type TakeMedicationListItemProps = {
  takeMedication: TakingMedication;
  isSelected: boolean;
  onPress: () => void;
};
const { width } = Dimensions.get("window");

export default function TakeMedicationListItem({
  takeMedication,
  isSelected,
  onPress,
}: TakeMedicationListItemProps) {
