...
type HealthSymptomListItemProps = {
  healthSymptom: Medication;
  isSelected: boolean;
  onPress: () => void;
};
...
export default function HealthSymptomListItem({
  healthSymptom,
  isSelected,
  onPress,
}: HealthSymptomListItemProps) {
