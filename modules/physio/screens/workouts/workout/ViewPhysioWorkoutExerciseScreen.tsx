...
export default function ViewPhysioWorkoutExerciseScreen() {
  ...
  const route =
    useRoute<RouteProp<PhysioWorkoutStack, "ViewPhysioWorkoutExercise">>();
  ...
  // const equipment = exerciseEquipments
  //   .filter((eq) => eq.exercise_id === id)
  //   .map((equipment) =>
  //     equipments.find((equip) => equip.id === equipment.equipment_id)
  //   );
