...
import { ResourcesGuideStackRoutes } from "../../../navigation/Routes";
...
export default function GuideListItem({ guide, type }: GuideItemProps) {
  const isWeb = Platform.OS === "web";
  const navigation =
    useNavigation<NativeStackNavigationProp<ResourcesGuideStackRoutes>>();
